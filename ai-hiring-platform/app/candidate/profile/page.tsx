            ...
            <div className="space-y-6">
                <Card className="border-none shadow-sm rounded-3xl overflow-hidden bg-card p-8 text-center space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-xs text-muted-foreground italic">"Almost there! Add your portfolio link to reach 100%."</p>
                    </div>

                    <hr className="border-muted/50" />

                    <div className="space-y-3">
                        <Button variant="outline" className="w-full rounded-xl gap-2 font-bold h-11" asChild>
                            <label className="cursor-pointer">
                                <FileText className="h-4 w-4" />
                                Update Resume
                                <input type="file" className="hidden" onChange={(e) => {
                                    // Handle file upload if needed later
                                    alert("Resume upload coming soon! For now, please paste text in resume section.")
                                }} />
                            </label>
                        </Button>
